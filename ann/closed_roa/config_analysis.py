...
configs_path = r'ann/closed_roa/save/run2_coarse_grid_repeat1/configs.pkl'
losses_path = r'ann/closed_roa/save/run2_coarse_grid_repeat1/config_losses.pkl'
avg_losses_path = r'ann/closed_roa/save/run2_coarse_grid_repeat1/avg_config_losses.pkl'
