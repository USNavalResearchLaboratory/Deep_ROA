...
load_path = r'./ann/closed_roa/load'                                                                    # [-] Relative path to the directory from which to load network data.
...
plt.xlabel( r'State Variable 1, $x_1$', fontsize = 14 )
plt.ylabel( r'State Variable 2, $x_2$', fontsize = 14 )
plt.title( 'Closed ROA Estimates', fontsize = 14, fontweight = 'bold' )
