...
class pde_class(  ):
    ...
    def plot_initial_boundary_conditions( self, num_points_per_dimension, domain = None, initial_boundary_conditions = None, projection_dimensions = None, projection_values = None, level = 0, fig_targets = None, save_directory = r'.', as_surface = None, as_stream = True, as_contour = True, show_plot = False ):
