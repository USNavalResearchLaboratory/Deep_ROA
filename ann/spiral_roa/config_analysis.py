...
configs_path = r'ann/spiral_roa/save/run5_larger_coarse_grid_closed_BCs/configs.pkl'
losses_path = r'ann/spiral_roa/save/run5_larger_coarse_grid_closed_BCs/config_losses.pkl'
avg_losses_path = r'ann/spiral_roa/save/run5_larger_coarse_grid_closed_BCs/avg_config_losses.pkl'
