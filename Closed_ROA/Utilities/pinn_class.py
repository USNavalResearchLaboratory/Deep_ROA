...
class pinn_class(  ):
    ...
    def __init__( self, pinn_options, hyperparameters, problem_specifications ):
        ...
        plotting_data = self.generate_plotting_data( self.pinn_options.num_plotting_samples, self.domain )
    ...
    def preprocess_classification_data( self, classification_data, num_spatial_dimensions, domain, plot_time, level, level_set_guesses, newton_tolerance, newton_max_iterations, exploration_radius, num_exploration_points, unique_tolerance, classification_noise_magnitude, domain_subset_type ):
        ...
        if classification_data is None:                 # If the classification data was not provided...
            ...
            if ( num_spatial_dimensions is not None ) and ( domain is not None ) and ( plot_time is not None ):
                ...
                classification_data = self.network.generate_classification_data( num_spatial_dimensions, domain, plot_time, level, level_set_guesses, newton_tolerance, newton_max_iterations, exploration_radius, num_exploration_points, unique_tolerance, classification_noise_magnitude, domain_subset_type )
    ...
    def generate_initial_boundary_condition_data( self, num_samples = None, domain = None, initial_boundary_conditions = None, application = 'training' ):
    ...
    def generate_residual_data( self, num_samples = None, domain = None, batch_size = None, application = 'training' ):
    ...
    def generate_training_testing_data( self, num_samples = None, domain = None, initial_boundary_conditions = None, residual_batch_size = None, element_volume_percent = None, element_type = None, element_computation_option = None, integration_order = None, application = 'training' ):
        ...
        initial_condition_data = self.generate_initial_boundary_condition_data( num_samples, domain, initial_conditions, application )

        # Generate the boundary condition data.
        boundary_condition_data = self.generate_initial_boundary_condition_data( num_samples, domain, boundary_conditions, application )

        # Generate the residual data.
        residual_data = self.generate_residual_data( num_samples, domain, residual_batch_size, application )
    ...
    def generate_plotting_data( self, num_plotting_samples = None, domain = None ):
    ...
    def generate_layers( self, num_inputs, num_outputs, num_hidden_layers, hidden_layer_widths ):
        ...
        # Create the network layers.
        layers = torch.tensor( [ num_inputs, *( num_hidden_layers*[ hidden_layer_widths ] ), num_outputs ], dtype = torch.uint8, device = self.pinn_options.device )
    ...
    def plot_initial_boundary_condition( self, num_points_per_dimension, pde = None, projection_dimensions = None, projection_values = None, level = 0, fig = None, save_directory = None, as_surface = True, as_stream = True, as_contour = True, show_plot = False ):

        # Setup for plotting the initial-boundary conditions.
        pde, save_directory = self.setup_pde_plotting( pde, save_directory )

        # Plot the initial boundary conditions.
        figs, axes = pde.plot_initial_boundary_conditions( num_points_per_dimension, pde.domain, pde.initial_boundary_conditions, projection_dimensions, projection_values, level, fig, save_directory, as_surface, as_stream, as_contour, show_plot )
    ...
    def plot_network_level_set_at_time( self, domain = None, network = None, plot_times = None, level = None, level_set_guess = None, num_guesses = None, newton_tolerance = None, newton_max_iterations = None, exploration_radius = None, num_exploration_points = None, unique_tolerance = None, projection_dimensions = None, projection_values = None, fig = None, dimension_labels = None, save_directory = r'.', as_surface = False, as_stream = False, as_contour = False, show_plot = False ):
        ...
        fig, ax = network.plot_network_level_set_at_time( domain.num_spatial_dimensions, domain, plot_times, level, level_set_guess, newton_tolerance, newton_max_iterations, exploration_radius, num_exploration_points, unique_tolerance, domain_subset_type, projection_dimensions, projection_values, fig, dimension_labels, save_directory, as_surface, as_stream, as_contour, show_plot )
    ...
    def plot_network_initial_level_set( self, domain = None, network = None, level = None, level_set_guess = None, num_guesses = None, newton_tolerance = None, newton_max_iterations = None, exploration_radius = None, num_exploration_points = None, unique_tolerance = None, projection_dimensions = None, projection_values = None, fig = None, dimension_labels = None, save_directory = r'.', as_surface = False, as_stream = False, as_contour = False, show_plot = False ):
        ...
        # Plot the network predictions as the specified time.
        fig, ax = self.plot_network_level_set_at_time( domain, network, plot_times, level, level_set_guess, num_guesses, newton_tolerance, newton_max_iterations, exploration_radius, num_exploration_points, unique_tolerance, projection_dimensions, projection_values, fig, dimension_labels, save_directory, as_surface, as_stream, as_contour, show_plot )
    ...
    def plot_network_final_level_set( self, domain = None, network = None, level = None, level_set_guess = None, num_guesses = None, newton_tolerance = None, newton_max_iterations = None, exploration_radius = None, num_exploration_points = None, unique_tolerance = None, projection_dimensions = None, projection_values = None, fig = None, dimension_labels = None, save_directory = r'.', as_surface = False, as_stream = False, as_contour = False, show_plot = False ):
